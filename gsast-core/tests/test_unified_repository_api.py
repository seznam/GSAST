...
from gsast_core.repolib.api import UnifiedRepositoryAPI, _build_cache_key
...
from gsast_core.models.config_models import (
    TargetConfig,
    FiltersConfig,
    GitHubTargetConfig,
    GitLabTargetConfig,
...
class TestUnifiedRepositoryAPIInitialization:
    ...
    def test_github_provider_initialization_success(self):
        ...
        with patch('gsast_core.repolib.api.GITHUB_API_TOKEN', 'test_GITHUB_API_TOKEN'):
            with patch('gsast_core.repolib.api.GitHubProvider') as mock_github_provider:
    ...
    def test_gitlab_provider_initialization_success(self):
        ...
        with patch('gsast_core.repolib.api.GITLAB_API_TOKEN', 'test_GITLAB_API_TOKEN'):
            with patch('gsast_core.repolib.api.GITLAB_URL', 'https://gitlab.example.com'):
                with patch('gsast_core.repolib.api.GitLabProvider') as mock_gitlab_provider:
                    mock_provider_instance = Mock()
    ...
    def test_github_provider_missing_token_error(self):
        ...
        with patch('gsast_core.repolib.api.GITHUB_API_TOKEN', None):
    ...
    def test_gitlab_provider_missing_token_error(self):
        ...
        with patch('gsast_core.repolib.api.GITLAB_API_TOKEN', None):
    ...
    def test_github_provider_initialization_failure(self):
        ...
        with patch('gsast_core.repolib.api.GITHUB_API_TOKEN', 'test_token'):
            with patch('gsast_core.repolib.api.GitHubProvider') as mock_github_provider:
    ...
    def test_gitlab_provider_initialization_failure(self):
        ...
        with patch('gsast_core.repolib.api.GITLAB_API_TOKEN', 'test_token'):
            with patch('gsast_core.repolib.api.GITLAB_URL', 'https://gitlab.com'):
                with patch('gsast_core.repolib.api.GitLabProvider') as mock_gitlab_provider:
...
class TestUnifiedRepositoryAPIGetRepositoriesUrls:
    ...
    def test_get_repositories_urls_returns_correct_urls(self):
        ...
        with patch('gsast_core.repolib.api.GITHUB_API_TOKEN', 'test_token'):
            with patch('gsast_core.repolib.api.GitHubProvider'):
                api = UnifiedRepositoryAPI(filters=self.filters, target=self.target)
...
class TestUnifiedRepositoryAPIGetProviderType:
    ...
    def test_get_provider_type_gitlab(self):
        ...
        with patch('gsast_core.repolib.api.GITLAB_API_TOKEN', 'test_token'):
            with patch('gsast_core.repolib.api.GITLAB_URL', 'https://gitlab.com'):
                with patch('gsast_core.repolib.api.GitLabProvider'):
                    api = UnifiedRepositoryAPI(filters=filters, target=target)
...
class TestUnifiedRepositoryAPICache:
    ...
    def _make_api(self, cache_backend=None, target=None, filters=None):
        ...
        if filters is None:
            filters = FiltersConfig(is_archived=False)
        with patch('gsast_core.repolib.api.GITHUB_API_TOKEN', 'test_token'):
            with patch('gsast_core.repolib.api.GitHubProvider') as mock_cls:
