...
from gsast_core.sastlib.scanner_interface import (
    ScannerInterface, ScannerRequirement, PluginMetadata
)
from gsast_core.sastlib.sarif_validator import SarifValidator
...
class TestScannerRequirements:
    ...
    def test_scanner_requirement_creation(self):
        ...
        from gsast_core.sastlib.scanner_interface import ScannerRequirement
